...
# def show_games(env, n_games, q_table, time_between_plays=0.2): #time = 0.2 initially
...
def show_games(env, n_games, q_table, time_between_plays=0.0000000000001, max_time_per_game=12):  # Add max_time_per_game parameter
    # assert env.with_rendering, "You need to activate rendering on the \
    # environment to see the game"
